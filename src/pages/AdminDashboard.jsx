...
const statusBadge = {
    open: { label: 'Open', color: 'bg-warning-50 text-warning-600', icon: AlertCircle },
    ...
    'pending-review': { label: 'Pending', color: 'bg-gray-100 text-gray-500', icon: Clock },
    rejected: { label: 'Rejected', color: 'bg-danger-50 text-danger-600', icon: AlertCircle },
};
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    {stats.map((stat, i) => (
                        <motion.div
                            ...
                            className={`bg-white rounded-2xl p-5 shadow-card flex items-center gap-4 ${stat.urgent ? 'ring-2 ring-danger-500/30' : ''
                                }`}
                        >
                            <div
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-4 border-b border-gray-100">
                        ...
                        <div className="relative max-w-xs w-full">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 rounded-xl border border-gray-200 bg-gray-50 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                            />
                        </div>
                    </div>
                                        ...
                                        <div className="flex flex-col lg:flex-row lg:items-start gap-4">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex flex-wrap items-center gap-2 mb-1.5">
                                                    ...
                                                    {overdue && (
                                                        <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-xs font-semibold bg-danger-100 text-danger-700 badge-urgent">
                                                            Overdue
                                                        </span>
                                                    )}
                                            ...
                                            <div className="flex items-center gap-2 flex-shrink-0">
                                                ...
                                                {complaint.status === 'open' && (
                                                    <button
                                                        ...
                                                        className="px-3 py-2 rounded-xl text-xs font-medium bg-primary-50 text-primary-700 hover:bg-primary-100 transition-colors flex items-center gap-1.5"
                                                    >
                                                ...
                                                {complaint.deadline &&
                                                    ...
                                                    complaint.extensions < 2 && (
                                                        <button
                                                            ...
                                                            className="px-3 py-2 rounded-xl text-xs font-medium bg-warning-50 text-warning-700 hover:bg-warning-100 transition-colors flex items-center gap-1.5"
                                                        >
                ...
                {showResponseModal && selectedComplaint && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed inset-4 md:inset-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-full md:max-w-lg z-50 bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]"
                        >
                            <div
                            ...
                            <div className="p-6 overflow-y-auto">
                                ...
                                {actionType === 'extend' ? (
                                    <div className="bg-warning-50 rounded-xl p-4 mb-5 flex items-center gap-3">
                                        <Timer className="w-6 h-6 text-warning-600 flex-shrink-0" />
                                        <div>
                                    ...
                                    <>
                                        ...
                                        <textarea
                                            ...
                                            rows={4}
                                            className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-gray-900 placeholder-gray-400 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent resize-none mb-4"
                                        />
                                        ...
                                        {actionType === 'resolve' && (
                                            <div className="mb-5">
                                                ...
                                                <label className="flex items-center gap-3 px-4 py-3 rounded-xl border-2 border-dashed border-gray-200 bg-gray-50 hover:border-success-300 cursor-pointer transition-all">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        {proofName ? (
                                                            <>
                                                                <p className="text-sm font-medium text-gray-900 truncate">{proofName}</p>
                                                                <p className="text-xs text-gray-400">Click to change</p>
                                                            </>
                                                        ) : (
                                                            <>
                                                                <p className="text-sm font-medium text-gray-500">Upload proof image</p>
